...
public class SimpleMoveAnimator implements Camera {
	 ...
	 * @param vf current forward speed
	 * @param dt diff of time
	 ...
	 * @param vs current side speed speed
	 * @param dt diff of time
	 * @param time current time
	 * @return new forward speed
	 */
	double calcSideSpeed(double vs, double dt, double time) {
	 ...
	 * @param vu current up/down speed
	 * @param dt diff of time
	 * @param time current time
	 * @return new forward speed
	 */
	double calcUpSpeed(double vu, double dt, double time) {
	 ...
	 * @param wh current horizontal rotation speed
	 * @param dt diff of time
	 * @param time current time
	 * @return new horizontal rotation
	 */
	double calcHorizontallySpeed(double wh, double dt, double time) {
	...
	/** Set speed active.
	 * @param speedDirection speed direction
	...
	public String info() {
		...
		for (Speeds s : Speeds.values()) {
			...
			speedsStr += "" + s + ", active: " + speedData.active
					+ ", last: " + speedData.last
					+ ", start: " + speedData.start
					+ "\n";
